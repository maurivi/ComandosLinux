...
1. [copiar archivo](#copy-a-file)
1. [duplicar archivo](#duplicate-a-file)
1. [copiar directorio](#copy-a-directory)
1. [duplicar directorio](#duplicate-a-directory)
1. [mover archivo](#move-a-file)
1. [renombrar archivo](#rename-a-file)
1. [mover directorio](#move-a-directory)
1. [renombrar directorio](#rename-a-directory)
1. [fusionar directorios](#merge-directories)
1. [crear nuevo archivo](#create-a-new-file)
1. [crear nuevo directorio](#create-a-new-directory)
1. [mostrar tamanio directorio/archivo](#show-filedirectory-size)
1. [mostrarinformacion de directorio/archivo](#show-filedirectory-info)
